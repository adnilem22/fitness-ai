...
INSERT INTO `client_types` VALUES (1,'admin'),(2,'user');
...
INSERT INTO `equipment` VALUES (4,'assisted'),(19,'band'),(6,'barbell'),(1,'body weight'),(14,'bosu ball'),(2,'cable'),(9,'dumbbell'),(23,'elliptical machine'),(10,'ez barbell'),(20,'hammer'),(11,'kettlebell'),(3,'leverage machine'),(29,'machine'),(5,'medicine ball'),(12,'olympic barbell'),(28,'resistance band'),(25,'roller'),(7,'rope'),(24,'skierg machine'),(15,'sled machine'),(16,'smith machine'),(8,'stability ball'),(21,'stationary bike'),(26,'stepmill machine'),(27,'tire'),(18,'trap bar'),(22,'upper body ergometer'),(13,'weighted'),(17,'wheel roller');
...
CREATE TABLE `exercises` (
  ...
  CONSTRAINT `fk_target_id` FOREIGN KEY (`target_id`) REFERENCES `targets` (`target_id`)
...
INSERT INTO `exercises` VALUES ('0001','Push-Up','chest','body weight','pectorals',3,1,'https://www.youtube.com/watch?v=IODxDxX7oi4'),('0002','Barbell Curl','upper arms','barbell','biceps',7,6,'https://www.youtube.com/watch?v=kwG2ipFRgfo'),('0003','Squat','legs','body weight','quads',6,1,'https://www.youtube.com/watch?v=xqvCmoLULNY'),('0004','Plank','core','body weight','abs',1,1,'https://www.youtube.com/watch?v=ASdvN_XEl_c'),('0005','Lateral Raise','shoulders','dumbbell','delts',10,9,'https://www.youtube.com/watch?v=3VcKaXpzqRo'),('0006','Deadlift','back','barbell','glutes',9,6,'https://www.youtube.com/watch?v=ZaTM37cfiDs'),('0007','Triceps Dips','upper arms','body weight','triceps',5,1,'https://www.youtube.com/watch?v=0326dy_-CzM'),('0008','Hip Abduction','legs','resistance band','abductors',18,28,'https://www.youtube.com/watch?v=c9AFSswN8xg'),('0009','Inner Thigh Machine','legs','leverage machine','adductors',15,3,'https://www.youtube.com/watch?v=Gff28pYH6f0'),('0010','Calf Raise','legs','body weight','calves',13,1,'https://www.youtube.com/watch?v=gwLzBJYoWlI'),('0011','Burpees','full body','body weight','cardio',20,1,'https://www.youtube.com/watch?v=qLBImHhCXSw'),('0012','Mountain Climbers','core','body weight','abs',1,1,'https://www.youtube.com/watch?v=cnyTQDSE884'),('0013','Chest Fly','chest','dumbbell','pectorals',3,9,'https://www.youtube.com/watch?v=eozdVDA78K0'),('0014','Leg Extension','legs','machine','quads',6,29,'https://www.youtube.com/watch?v=4ZDm5EbiFI8'),('0015','Bench Press','chest','barbell','pectorals',3,6,'https://www.youtube.com/watch?v=hWbUlkb5Ms4'),('0016','Overhead Press','shoulders','barbell','delts',10,6,'https://www.youtube.com/watch?v=yEbczj_FGyI'),('0017','Jump Rope','full body','rope','cardio',20,7,'https://www.youtube.com/watch?v=fm0WpJsWBA8'),('0018','Jumping Jacks','full body','body weight','cardio',20,1,'https://www.youtube.com/watch?v=c4DAnQ6DtF8'),('0019','Pull-Up','back','body weight','lats',2,1,'https://www.youtube.com/watch?v=eGo4IYlbE5g'),('0020','Bent-Over Row','back','barbell','upper back',8,6,'https://www.youtube.com/watch?v=vT2GjY_Umpw'),('0021','Bulgarian Split Squat','legs','dumbbell','quads',6,9,'https://www.youtube.com/watch?v=2C-uNgKwPLE'),('0022','Russian Twist','core','medicine ball','abs',1,5,'https://www.youtube.com/watch?v=wkD8rjkodUI'),('0023','Side Plank','core','body weight','abs',1,1,'https://www.youtube.com/watch?v=wqzrb67Dwf8'),('0024','Cable Bicep Curl','upper arms','cable','biceps',7,2,'https://www.youtube.com/watch?v=av7-8igSXTs'),('0025','Goblet Squat','legs','dumbbell','quads',6,9,'https://www.youtube.com/watch?v=6xwNBSyehJs'),('0026','Hip Thrust','glutes','barbell','glutes',9,6,'https://www.youtube.com/watch?v=LM8XHLYJoYs'),('0027','Arnold Press','shoulders','dumbbell','delts',10,9,'https://www.youtube.com/watch?v=vj2w851ZHRM'),('0028','Seated Leg Curl','legs','machine','hamstrings',4,29,'https://www.youtube.com/watch?v=ZRJBPahggLw'),('0029','Romanian Deadlift','legs','barbell','hamstrings',4,6,'https://www.example.com/romanian_deadlift.gif'),('0030','Dumbbell Bench Press','chest','dumbbell','pectorals',3,9,'https://www.example.com/dumbbell_bench_press.gif'),('0031','Cable Triceps Pushdown','upper arms','cable','triceps',5,2,'https://www.example.com/cable_triceps_pushdown.gif');
...
INSERT INTO `fitness_goals` VALUES (1,'Lose weight'),(2,'Gain muscle'),(3,'Build strength'),(4,'Increase endurance');
/*!40000 ALTER TABLE `fitness_goals` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fitness_levels`
--
...
--
-- Dumping data for table `fitness_levels`
--

LOCK TABLES `fitness_levels` WRITE;
/*!40000 ALTER TABLE `fitness_levels` DISABLE KEYS */;
INSERT INTO `fitness_levels` VALUES (1,'Beginner'),(2,'Intermediate'),(3,'Advanced');
/*!40000 ALTER TABLE `fitness_levels` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `personalized_workouts`
--

DROP TABLE IF EXISTS `personalized_workouts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `personalized_workouts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  `exercises_id` varchar(50) DEFAULT NULL,
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `personalized_workouts_ibfk_1` FOREIGN KEY (`exercises_id`) REFERENCES `exercises` (`id`),
  CONSTRAINT `personalized_workouts_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=618 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `personalized_workouts`
--

LOCK TABLES `personalized_workouts` WRITE;
/*!40000 ALTER TABLE `personalized_workouts` DISABLE KEYS */;
INSERT INTO `personalized_workouts` VALUES (7,1,NULL,'Day 1','Squats','Legs','Barbell','Quadriceps, Glutes, Hamstrings',4,12,135,60,NULL),(8,1,NULL,'Day 1','Bench Press','Chest','Barbell','Pectorals, Triceps, Shoulders',4,10,155,60,NULL),(9,1,NULL,'Day 2','Deadlifts','Back','Barbell','Lower back, Glutes, Hamstrings',4,8,185,90,NULL),(10,1,NULL,'Day 2','Pull-ups','Back','Pull-up bar','Lats, Biceps, Shoulders',4,8,0,60,NULL),(11,1,NULL,'Day 3','Shoulder Press','Shoulders','Dumbbells','Deltoids, Triceps',3,12,25,45,NULL),(12,1,NULL,'Day 3','Plank','Core','Body weight','Abdominals, Core muscles',3,0,0,30,NULL),(13,1,NULL,'Week 1 - Day 1','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(14,1,NULL,'Week 1 - Day 2','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(15,1,NULL,'Week 1 - Day 3','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(16,1,NULL,'Week 1 - Day 4','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(17,1,NULL,'Week 1 - Day 5','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(18,1,NULL,'Week 1 - Day 1','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(19,1,NULL,'Week 1 - Day 2','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(20,1,NULL,'Week 1 - Day 3','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(21,1,NULL,'Week 1 - Day 4','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(22,1,NULL,'Week 1 - Day 5','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(23,1,NULL,'Unknown Day','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(24,1,NULL,'Unknown Day','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(25,1,NULL,'Unknown Day','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(26,1,NULL,'Unknown Day','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(27,1,NULL,'Unknown Day','Unknown Exercise','Unknown','Unknown','Unknown',3,10,0,60,NULL),(28,1,NULL,'Week 1 - Day 1','Bench Press','Chest','Barbell','Strength',4,8,80,60,NULL),(29,1,NULL,'Week 1 - Day 1','Tricep Dips','Triceps','Bodyweight','Hypertrophy',3,12,0,45,NULL),(30,1,NULL,'Week 1 - Day 2','Deadlifts','Back','Barbell','Strength',4,6,100,90,NULL),(31,1,NULL,'Week 1 - Day 1','','','','',3,10,0,60,NULL),(32,1,NULL,'Week 1 - Day 2','','','','',3,10,0,60,NULL),(33,1,NULL,'Week 1 - Day 3','','','','',3,10,0,60,NULL),(34,1,NULL,'Week 1 - Day 4','','','','',3,10,0,60,NULL),(35,1,NULL,'Week 1 - Day 5','','','','',3,10,0,60,NULL),(36,1,NULL,'Day 1','Barbell Squats','Legs','Barbell','Quadriceps, Glutes, Hamstrings',4,8,0,90,NULL),(37,1,NULL,'Day 1','Romanian Deadlifts','Hamstrings, Lower back','Barbell','Hamstrings, Glutes, Lower back',4,10,0,60,NULL),(38,1,NULL,'Day 2','Bench Press','Chest','Barbell','Chest, Triceps, Shoulders',4,8,0,90,NULL),(39,1,NULL,'Day 2','Dumbbell Flyes','Chest','Dumbbells','Chest, Shoulders',4,12,0,60,NULL),(40,1,NULL,'Day 3','Pull-Ups','Back','Bodyweight','Back, Biceps',4,8,0,90,NULL),(41,1,NULL,'Day 3','Bent Over Rows','Back','Barbell','Back, Biceps',4,10,0,60,NULL),(42,1,NULL,'Day 4','Military Press','Shoulders','Barbell','Shoulders, Triceps',4,8,0,90,NULL),(43,1,NULL,'Day 4','Lateral Raises','Shoulders','Dumbbells','Shoulders',4,12,0,60,NULL),(44,1,NULL,'Day 5','Barbell Curls','Biceps','Barbell','Biceps',4,10,0,60,NULL),(45,1,NULL,'Day 5','Skull Crushers','Triceps','Barbell','Triceps',4,10,0,60,NULL),(46,1,NULL,'Day 6','Leg Press','Legs','Machine','Quadriceps, Hamstrings, Glutes',4,12,0,60,NULL),(47,1,NULL,'Day 7','Rest','Rest','None','Rest',0,0,0,0,NULL),(48,1,NULL,'Unknown Day','Squats','Legs','Barbell','Quadriceps',4,8,0,60,NULL),(49,1,NULL,'Unknown Day','Leg Press','Legs','Machine','Hamstrings',3,10,0,60,NULL),(50,1,NULL,'Unknown Day','Bench Press','Chest','Barbell','Pectorals',4,8,0,60,NULL),(51,1,NULL,'Unknown Day','Incline Dumbbell Press','Chest','Dumbbells','Upper Chest',3,10,0,60,NULL),(52,1,NULL,'Unknown Day','Pull-ups','Back','Bodyweight','Lats',4,8,0,60,NULL),(53,1,NULL,'Unknown Day','Barbell Rows','Back','Barbell','Mid Back',3,10,0,60,NULL),(54,1,NULL,'Unknown Day','Shoulder Press','Shoulders','Barbell','Shoulder Deltoids',4,8,0,60,NULL),(55,1,NULL,'Unknown Day','Lateral Raises','Shoulders','Dumbbells','Side Delts',3,12,0,60,NULL),(56,1,NULL,'Unknown Day','Deadlifts','Back','Barbell','Lower Back',4,6,0,90,NULL),(57,1,NULL,'Unknown Day','Hammer Curls','Arms','Dumbbells','Biceps',3,12,0,60,NULL),(58,1,NULL,'Day 1','Barbell Squats','Legs','Barbell','Quadriceps',4,10,135,60,NULL),(59,1,NULL,'Day 1','Bench Press','Chest','Barbell','Pectorals',4,10,135,60,NULL),(60,1,NULL,'Day 2','Deadlifts','Back','Barbell','Erector Spinae',4,10,185,60,NULL),(61,1,NULL,'Day 2','Pull-Ups','Back','Bodyweight','Latissimus Dorsi',4,10,0,60,NULL),(62,1,NULL,'Day 3','Shoulder Press','Shoulders','Dumbbells','Deltoids',4,10,30,60,NULL),(63,1,NULL,'Day 3','Lunges','Legs','Bodyweight','Glutes',4,10,0,60,NULL),(64,1,NULL,'Day 4','Bicep Curls','Arms','Barbell','Biceps',4,10,40,60,NULL),(65,1,NULL,'Day 4','Tricep Dips','Arms','Parallel Bars','Triceps',4,10,0,60,NULL),(66,1,NULL,'Day 5','Leg Press','Legs','Leg Press Machine','Hamstrings',4,10,180,60,NULL),(67,1,NULL,'Day 5','Chest Flys','Chest','Dumbbells','Pectorals',4,10,20,60,NULL),(68,1,NULL,'Day 6','Lat Pulldowns','Back','Cable Machine','Latissimus Dorsi',4,10,100,60,NULL),(69,1,NULL,'Day 6','Seated Shoulder Press','Shoulders','Barbell','Deltoids',4,10,50,60,NULL),(70,1,NULL,'Day 7','Hammer Curls','Arms','Dumbbells','Biceps',4,10,25,60,NULL),(71,1,NULL,'Day 7','Skull Crushers','Arms','Barbell','Triceps',4,10,30,60,NULL),(72,1,NULL,'Day 1','Bench Press','Chest','Barbell','Pectoralis Major',4,10,135,60,NULL),(73,1,NULL,'Day 1','Tricep Dips','Triceps','Bodyweight','Triceps Brachii',3,12,0,45,NULL),(74,1,NULL,'Day 2','Pull-Ups','Back','Bodyweight','Latissimus Dorsi',4,8,0,60,NULL),(75,1,NULL,'Day 2','Barbell Rows','Back','Barbell','Trapezius',3,10,95,45,NULL),(76,1,NULL,'Day 2','Bicep Curls','Biceps','Dumbbells','Biceps Brachii',3,12,25,45,NULL),(77,1,NULL,'Day 3','Squats','Legs','Barbell','Quadriceps',4,12,155,60,NULL),(78,1,NULL,'Day 3','Lunges','Legs','Dumbbells','Hamstrings',3,10,30,45,NULL),(79,1,NULL,'Day 4','Shoulder Press','Shoulders','Barbell','Deltoids',4,10,65,60,NULL),(80,1,NULL,'Day 4','Lateral Raises','Shoulders','Dumbbells','Medial Deltoids',3,12,15,45,NULL),(81,1,NULL,'Day 5','Deadlifts','Back','Barbell','Erector Spinae',4,8,185,60,NULL),(82,1,NULL,'Day 5','Hammer Curls','Biceps','Dumbbells','Brachialis',3,12,20,45,NULL),(83,1,NULL,'Day 6','Incline Bench Press','Chest','Barbell','Upper Pectoralis Major',4,10,115,60,NULL),(84,1,NULL,'Day 7','Plank','Core','Bodyweight','Rectus Abdominis',3,60,0,45,NULL),(85,1,NULL,'Day 1','Bench Press','Chest','Barbell','Pectoralis Major',4,10,135,60,NULL),(86,1,NULL,'Day 1','Tricep Dips','Triceps','Bodyweight/Dip Bar','Triceps Brachii',4,12,0,60,NULL),(87,1,NULL,'Day 2','Bent Over Rows','Back','Barbell','Latissimus Dorsi',4,10,95,60,NULL),(88,1,NULL,'Day 2','Barbell Bicep Curls','Biceps','Barbell','Biceps Brachii',4,12,45,60,NULL),(89,1,NULL,'Day 3','Squats','Legs','Barbell','Quadriceps',4,10,185,60,NULL),(90,1,NULL,'Day 3','Leg Press','Legs','Machine','Hamstrings',4,12,200,60,NULL),(91,1,NULL,'Day 4','Shoulder Press','Shoulders','Dumbbells','Deltoids',4,10,30,60,NULL),(92,1,NULL,'Day 4','Lateral Raises','Shoulders','Dumbbells','Lateral Deltoids',4,12,15,60,NULL),(93,1,NULL,'Day 5','Deadlifts','Back','Barbell','Erector Spinae',4,8,225,60,NULL),(94,1,NULL,'Day 5','Chin-ups','Back/Biceps','Bodyweight/Pull-up Bar','Biceps Brachii',4,10,0,60,NULL),(95,1,NULL,'Day 1','Bench Press','Chest','Barbell','Pectorals',4,10,135,60,NULL),(96,1,NULL,'Day 1','Tricep Dips','Triceps','Body Weight','Triceps',3,12,0,60,NULL),(97,1,NULL,'Day 2','Pull-Ups','Back','Body Weight','Latissimus Dorsi',4,8,0,60,NULL),(98,1,NULL,'Day 2','Barbell Rows','Back','Barbell','Middle Back',3,10,95,60,NULL),(99,1,NULL,'Day 2','Bicep Curls','Biceps','Dumbbells','Biceps',3,12,20,60,NULL),(100,1,NULL,'Day 3','Squats','Legs','Barbell','Quadriceps',4,10,155,60,NULL),(101,1,NULL,'Day 3','Leg Press','Legs','Machine','Hamstrings',3,12,200,60,NULL),(102,1,NULL,'Day 4','Overhead Press','Shoulders','Barbell','Shoulders',4,10,75,60,NULL),(103,1,NULL,'Day 4','Lateral Raises','Shoulders','Dumbbells','Lateral Delts',3,12,15,60,NULL),(104,1,NULL,'Day 5','Deadlifts','Back','Barbell','Lower Back',4,8,185,60,NULL),(105,1,NULL,'Day 5','Hammer Curls','Biceps','Dumbbells','Brachialis',3,12,25,60,NULL),(106,1,NULL,'Day 1','Bench Press','Chest','Barbell','Pectorals',4,10,135,60,NULL),(107,1,NULL,'Day 1','Tricep Dips','Triceps','Bodyweight','Triceps',4,12,0,60,NULL),(108,1,NULL,'Day 2','Pull-Ups','Back','Bodyweight','Lats',4,10,0,60,NULL),(109,1,NULL,'Day 2','Bicep Curls','Biceps','Dumbbells','Biceps',4,12,20,60,NULL),(110,1,NULL,'Day 3','Squats','Legs','Barbell','Quadriceps',4,10,185,60,NULL),(111,1,NULL,'Day 3','Leg Press','Legs','Machine','Quadriceps',4,12,200,60,NULL),(112,1,NULL,'Day 4','Overhead Press','Shoulders','Barbell','Shoulders',4,10,75,60,NULL),(113,1,NULL,'Day 4','Lateral Raises','Shoulders','Dumbbells','Shoulders',4,12,15,60,NULL),(114,1,NULL,'Day 5','Deadlifts','Back','Barbell','Back',4,8,225,60,NULL),(115,1,NULL,'Day 5','Hammer Curls','Biceps','Dumbbells','Biceps',4,12,25,60,NULL),(514,3,NULL,'Day 1','Dumbbell Bench Press','chest','dumbbell','pectorals',4,12,12,60,NULL),(515,3,NULL,'Day 1','Chest Fly','chest','dumbbell','pectorals',4,12,8,60,NULL),(516,3,NULL,'Day 1','Triceps Dips','triceps','body weight','triceps',4,12,0,60,NULL),(517,3,NULL,'Day 2','Hip Thrust','glutes','barbell','glutes',4,12,20,60,NULL),(518,3,NULL,'Day 2','Bulgarian Split Squat','quadriceps','body weight','quadriceps',4,12,0,60,NULL),(519,3,NULL,'Day 2','Calf Raise','calves','dumbbell','calves',4,15,10,60,NULL),(520,3,NULL,'Day 3','Pull-Up','back','body weight','latissimus dorsi',4,8,0,60,NULL),(521,3,NULL,'Day 3','Bent-Over Row','back','barbell','latissimus dorsi',4,12,15,60,NULL),(522,3,NULL,'Day 3','Barbell Curl','biceps','barbell','biceps',4,12,10,60,NULL),(523,3,NULL,'Day 4','Squat','quadriceps','barbell','quadriceps',4,12,20,60,NULL),(524,3,NULL,'Day 4','Leg Extension','quadriceps','machine','quadriceps',4,15,25,60,NULL),(525,3,NULL,'Day 4','Arnold Press','shoulders','dumbbell','delts',4,12,8,60,NULL),(526,3,NULL,'Day 4','Triceps Dips','triceps','body weight','triceps',4,12,0,60,NULL),(538,7,NULL,'Day 1','Push-Up','chest','body weight','pectorals',4,12,0,60,NULL),(539,7,NULL,'Day 1','Triceps Dips','triceps','parallel bars','triceps',4,12,0,60,NULL),(540,7,NULL,'Day 1','Bench Press','chest','barbell','pectorals',4,12,0,60,NULL),(541,7,NULL,'Day 2','Bent-Over Row','back','dumbbell','lats',4,12,0,60,NULL),(542,7,NULL,'Day 2','Seated Leg Curl','legs','machine','hamstrings',4,12,0,60,NULL),(543,7,NULL,'Day 3','Mountain Climbers','core','body weight','abdominals',4,30,0,60,NULL),(544,7,NULL,'Day 3','Jump Rope','cardio','rope','full body',4,60,0,60,NULL),(545,7,NULL,'Day 3','Cable Triceps Pushdown','triceps','cable machine','triceps',4,15,0,60,NULL),(546,7,NULL,'Day 4','Squat','legs','barbell','quadriceps',4,12,0,60,NULL),(547,7,NULL,'Day 4','Deadlift','back','barbell','hamstrings',4,12,0,60,NULL),(548,7,NULL,'Day 4','Russian Twist','core','medicine ball','obliques',4,20,0,60,NULL),(549,7,NULL,'Day 5','Lateral Raise','shoulders','dumbbell','deltoids',4,12,0,60,NULL),(550,7,NULL,'Day 5','Cable Bicep Curl','biceps','cable machine','biceps',4,15,0,60,NULL),(551,7,NULL,'Day 5','Plank','core','body weight','abdominals',4,60,0,60,NULL),(552,9,NULL,'Day 1','Push-Up','chest','body weight','pectorals',4,12,0,60,'https://www.youtube.com/watch?v=IODxDxX7oi4'),(553,9,NULL,'Day 1','Triceps Dips','triceps','parallel bars','triceps',3,15,0,45,'https://www.youtube.com/watch?v=0326dy_-CzM'),(554,9,NULL,'Day 2','Bulgarian Split Squat','legs','dumbbell','quadriceps',4,12,8,60,'https://www.youtube.com/watch?v=2C-uNgKwPLE'),(555,9,NULL,'Day 2','Jumping Jacks','full body','body weight','cardio',3,30,0,30,'https://www.youtube.com/watch?v=c4DAnQ6DtF8'),(556,9,NULL,'Day 3','Mountain Climbers','full body','body weight','cardio',4,20,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884'),(557,9,NULL,'Day 3','Russian Twist','core','body weight','obliques',3,20,0,45,'https://www.youtube.com/watch?v=wkD8rjkodUI'),(558,10,NULL,'Day 1','Push-Up','chest','body weight','pectorals',4,12,0,60,'https://www.youtube.com/watch?v=IODxDxX7oi4'),(559,10,NULL,'Day 1','Triceps Dips','triceps','parallel bars','triceps',4,12,0,60,'https://www.youtube.com/watch?v=0326dy_-CzM'),(560,10,NULL,'Day 1','Chest Fly','chest','dumbbell','pectorals',3,15,4,60,'https://www.youtube.com/watch?v=eozdVDA78K0'),(561,10,NULL,'Day 2','Mountain Climbers','core','body weight','abs',4,20,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884'),(562,10,NULL,'Day 2','Russian Twist','core','medicine ball','obliques',3,20,6,45,'https://www.youtube.com/watch?v=wkD8rjkodUI'),(563,10,NULL,'Day 2','Jumping Jacks','full body','body weight','cardio',3,30,0,30,'https://www.youtube.com/watch?v=c4DAnQ6DtF8'),(564,10,NULL,'Day 3','Squat','legs','barbell','quadriceps',4,12,20,90,'https://www.youtube.com/watch?v=xqvCmoLULNY'),(565,10,NULL,'Day 3','Jump Rope','cardio','jump rope','full body',4,1,0,60,'https://www.youtube.com/watch?v=fm0WpJsWBA8'),(566,10,NULL,'Day 3','Russian Twist','core','medicine ball','obliques',3,20,6,45,'https://www.youtube.com/watch?v=wkD8rjkodUI'),(567,10,NULL,'Day 3','Cable Triceps Pushdown','triceps','cable machine','triceps',3,15,10,60,'https://www.example.com/cable_triceps_pushdown.gif'),(568,10,NULL,'Day 4','Plank','core','body weight','core',4,45,0,60,'https://www.youtube.com/watch?v=ASdvN_XEl_c'),(569,10,NULL,'Day 4','Burpees','full body','body weight','cardio',4,15,0,60,'https://www.youtube.com/watch?v=qLBImHhCXSw'),(570,10,NULL,'Day 4','Mountain Climbers','core','body weight','abs',4,20,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884'),(571,10,NULL,'Day 4','Jump Rope','cardio','jump rope','full body',4,1,0,60,'https://www.youtube.com/watch?v=fm0WpJsWBA8'),(572,10,NULL,'Day 4','Leg Extension','legs','leg extension machine','quadriceps',3,15,25,60,'https://www.youtube.com/watch?v=4ZDm5EbiFI8'),(573,11,NULL,'Day 1','Bench Press','chest','barbell','pectorals',4,12,80,60,'https://www.youtube.com/watch?v=hWbUlkb5Ms4'),(574,11,NULL,'Day 1','Cable Triceps Pushdown','triceps','cable machine','triceps',4,12,25,60,'https://www.example.com/cable_triceps_pushdown.gif'),(575,11,NULL,'Day 1','Dumbbell Bench Press','chest','dumbbell','pectorals',4,12,30,60,'https://www.example.com/dumbbell_bench_press.gif'),(576,11,NULL,'Day 2','Bent-Over Row','back','barbell','lats',4,12,60,60,'https://www.youtube.com/watch?v=vT2GjY_Umpw'),(577,11,NULL,'Day 2','Barbell Curl','biceps','barbell','biceps',4,12,20,60,'https://www.youtube.com/watch?v=kwG2ipFRgfo'),(578,11,NULL,'Day 2','Lateral Raise','shoulders','dumbbell','deltoids',4,12,10,60,'https://www.youtube.com/watch?v=3VcKaXpzqRo'),(579,11,NULL,'Day 3','Deadlift','back','barbell','lower back',4,12,90,60,'https://www.youtube.com/watch?v=ZaTM37cfiDs'),(580,11,NULL,'Day 3','Romanian Deadlift','hamstrings','barbell','hamstrings',4,12,50,60,'https://www.example.com/romanian_deadlift.gif'),(581,11,NULL,'Day 3','Calf Raise','calves','body weight','calves',4,15,0,60,'https://www.youtube.com/watch?v=gwLzBJYoWlI'),(582,11,NULL,'Day 4','Dumbbell Bench Press','chest','dumbbell','pectorals',4,12,30,60,'https://www.example.com/dumbbell_bench_press.gif'),(583,11,NULL,'Day 4','Triceps Dips','triceps','parallel bars','triceps',4,12,0,60,'https://www.youtube.com/watch?v=0326dy_-CzM'),(584,11,NULL,'Day 4','Cable Bicep Curl','biceps','cable machine','biceps',4,12,20,60,'https://www.youtube.com/watch?v=av7-8igSXTs'),(585,11,NULL,'Day 5','Squat','quadriceps','barbell','quadriceps',4,12,60,60,'https://www.youtube.com/watch?v=xqvCmoLULNY'),(586,11,NULL,'Day 5','Goblet Squat','quadriceps','dumbbell','quadriceps',4,12,20,60,'https://www.youtube.com/watch?v=6xwNBSyehJs'),(587,11,NULL,'Day 5','Leg Extension','quadriceps','machine','quadriceps',4,12,40,60,'https://www.youtube.com/watch?v=4ZDm5EbiFI8'),(588,6,NULL,'Day 1','Dumbbell Bench Press','chest','dumbbell','pectorals',4,12,10,60,'https://www.example.com/dumbbell_bench_press.gif'),(589,6,NULL,'Day 1','Triceps Dips','triceps','body weight','triceps',4,12,0,60,'https://www.youtube.com/watch?v=0326dy_-CzM'),(590,6,NULL,'Day 1','Chest Fly','chest','dumbbell','pectorals',4,12,5,60,'https://www.youtube.com/watch?v=eozdVDA78K0'),(591,6,NULL,'Day 2','Bench Press','chest','barbell','pectorals',4,12,20,60,'https://www.youtube.com/watch?v=hWbUlkb5Ms4'),(592,6,NULL,'Day 2','Push-Up','chest','body weight','pectorals',4,12,0,60,'https://www.youtube.com/watch?v=IODxDxX7oi4'),(593,6,NULL,'Day 2','Triceps Dips','triceps','body weight','triceps',4,12,0,60,'https://www.youtube.com/watch?v=0326dy_-CzM'),(594,6,NULL,'Day 3','Dumbbell Bench Press','chest','dumbbell','pectorals',4,12,10,60,'https://www.example.com/dumbbell_bench_press.gif'),(595,6,NULL,'Day 3','Triceps Dips','triceps','body weight','triceps',4,12,0,60,'https://www.youtube.com/watch?v=0326dy_-CzM'),(596,6,NULL,'Day 3','Chest Fly','chest','dumbbell','pectorals',4,12,5,60,'https://www.youtube.com/watch?v=eozdVDA78K0'),(597,12,NULL,'Day 1','Jumping Jacks','full body','body weight','cardio',4,20,0,60,'https://www.youtube.com/watch?v=c4DAnQ6DtF8'),(598,12,NULL,'Day 1','Mountain Climbers','core','body weight','abdominals',3,15,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884'),(599,12,NULL,'Day 1','Burpees','full body','body weight','cardio',4,12,0,60,'https://www.youtube.com/watch?v=qLBImHhCXSw'),(600,12,NULL,'Day 2','Jump Rope','full body','jump rope','cardio',5,1,0,60,'https://www.youtube.com/watch?v=fm0WpJsWBA8'),(601,12,NULL,'Day 2','Russian Twist','core','body weight','obliques',3,20,0,45,'https://www.youtube.com/watch?v=wkD8rjkodUI'),(602,12,NULL,'Day 2','Mountain Climbers','core','body weight','abdominals',3,15,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884'),(603,12,NULL,'Day 3','Jump Rope','full body','jump rope','cardio',5,1,0,60,'https://www.youtube.com/watch?v=fm0WpJsWBA8'),(604,12,NULL,'Day 3','Burpees','full body','body weight','cardio',4,12,0,60,'https://www.youtube.com/watch?v=qLBImHhCXSw'),(605,12,NULL,'Day 3','Russian Twist','core','body weight','obliques',3,20,0,45,'https://www.youtube.com/watch?v=wkD8rjkodUI'),(606,12,NULL,'Day 4','Jump Rope','full body','jump rope','cardio',5,1,0,60,'https://www.youtube.com/watch?v=fm0WpJsWBA8'),(607,12,NULL,'Day 4','Mountain Climbers','core','body weight','abdominals',3,15,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884'),(608,12,NULL,'Day 4','Burpees','full body','body weight','cardio',4,12,0,60,'https://www.youtube.com/watch?v=qLBImHhCXSw'),(609,12,NULL,'Day 5','Jump Rope','full body','jump rope','cardio',5,1,0,60,'https://www.youtube.com/watch?v=fm0WpJsWBA8'),(610,12,NULL,'Day 5','Russian Twist','core','body weight','obliques',3,20,0,45,'https://www.youtube.com/watch?v=wkD8rjkodUI'),(611,12,NULL,'Day 5','Mountain Climbers','core','body weight','abdominals',3,15,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884'),(612,13,NULL,'Day 1','Push-Up','chest','body weight','pectorals',4,12,0,60,'https://www.youtube.com/watch?v=IODxDxX7oi4'),(613,13,NULL,'Day 1','Triceps Dips','triceps','body weight','triceps',3,15,0,60,'https://www.youtube.com/watch?v=0326dy_-CzM'),(614,13,NULL,'Day 2','Jumping Jacks','full body','none','cardio',5,30,0,45,'https://www.youtube.com/watch?v=c4DAnQ6DtF8'),(615,13,NULL,'Day 2','Burpees','full body','body weight','cardio',4,15,0,60,'https://www.youtube.com/watch?v=qLBImHhCXSw'),(616,13,NULL,'Day 3','Russian Twist','core','medicine ball','obliques',3,20,0,45,'https://www.youtube.com/watch?v=wkD8rjkodUI'),(617,13,NULL,'Day 3','Mountain Climbers','core','none','cardio',4,20,0,45,'https://www.youtube.com/watch?v=cnyTQDSE884');
/*!40000 ALTER TABLE `personalized_workouts` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-11-26 19:04:51',NULL),('diagnostics.include_raw','OFF','2024-11-26 19:04:51',NULL),('ps_thread_trx_info.max_length','65535','2024-11-26 19:04:51',NULL),('statement_performance_analyzer.limit','100','2024-11-26 19:04:51',NULL),('statement_performance_analyzer.view',NULL,'2024-11-26 19:04:51',NULL),('statement_truncate_len','64','2024-11-26 19:04:51',NULL);
...
INSERT INTO `targets` VALUES (18,'abductors'),(1,'abs'),(15,'adductors'),(7,'biceps'),(13,'calves'),(20,'cardio'),(17,'cardiovascular system'),(10,'delts'),(12,'forearms'),(9,'glutes'),(4,'hamstrings'),(2,'lats'),(19,'levator scapulae'),(3,'pectorals'),(6,'quads'),(11,'serratus anterior'),(16,'spine'),(14,'traps'),(5,'triceps'),(8,'upper back');
...
CREATE TABLE `users` (
  ...
  `fitness_level_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `client_type_id` (`client_type_id`),
  KEY `fk_fitness_goal` (`goal_id`),
  KEY `fk_fitness_level` (`fitness_level_id`),
  CONSTRAINT `fk_fitness_goal` FOREIGN KEY (`goal_id`) REFERENCES `fitness_goals` (`id`),
  CONSTRAINT `fk_fitness_level` FOREIGN KEY (`fitness_level_id`) REFERENCES `fitness_levels` (`id`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`client_type_id`) REFERENCES `client_types` (`id`)
...
INSERT INTO `users` VALUES (1,'John Doe','1995-06-15','Male',180,75,'+36201234567','hashed_password',1,NULL,NULL),(2,'asdfgh','2011-04-05','Other',146,36,'1336554789','$2y$10$ZXq6wekhzoUkU9PRp6vWD.COBFemjx45mYyx7rAnZNIP1QfAJVhwK',NULL,2,1),(3,'Nagy Anna','2000-04-13','Female',180,65,'0743237332','$2y$10$OezLIN8oZ9D0aLy2ltcaseTXJN/UdKtpxQCYNn6ppFtY8di8dui3O',NULL,2,2),(4,'Nagy Karoly','2003-05-03','Male',172,60,'0745109487','$2y$10$pMc.AK40MvD3MYgMbuwngOxR5Bcjbs5kw8i5nTbH.NZWCXIZpDnQy',NULL,2,1),(5,'Nagy Kinga','1999-06-10','Female',179,61,'0743237332','$2y$10$S6vcu5Cyj0IwIr4Hb63VRusuRlIVVfCAatw5RiA9gb/E63KhtGqTK',NULL,2,1),(6,'Kocsis Sandor','2000-06-02','Female',180,60,'0743237332','$2y$10$EYImK9HdZZXFcBZV6U6BTu5aTzsdBtugZlkAXeHhWWfMWXCvVK9na',NULL,2,1),(7,'dty','2025-07-01','Female',182,67,'0712345678','$2y$10$6vy1VO48TXuJ98RY167Q4OD8ugFzGQce1Dy3jGj3X7Mq2Qsmpj5H2',NULL,1,2),(8,'lilla','2000-07-14','Female',166,65,'0743237332','$2y$10$/GYyR9eoNfcSIkxdzuAJ0.Eliqak1exVoKCwgfjKzpIOOD1F4LKLq',NULL,1,1),(9,'anita','2001-07-15','Female',159,56,'0743237332','$2y$10$XAdY6t4wu3L.z/EoNrMrre8PbI3eih8Z7nrawrz4kXWOytF/nKtxq',NULL,1,1),(10,'k','1985-07-15','Female',164,63,'0743237332','$2y$10$5/nK.Kc4L/Dj5.zBWek3Re8IVfV2BUKf8vBpg3u7ivIjtrzYGg32W',NULL,1,2),(11,'dimitrie','2004-08-06','Male',183,73,'0743237332','$2y$10$bxCvSgbHsbRA9DdS58rcj.L9mJhp8kwK6y1vOstwnXx6//UuCcjke',NULL,2,3),(12,'dfwefd','2025-07-01','Female',146,38,'0743237332','$2y$10$R8sEMiMqNHUI5WuobCeguONbY6iEwYF9.DkXOos.XWVKAbZPci02q',NULL,1,2),(13,'klara','2000-07-17','Female',163,51,'0745623594','$2y$10$OVJ9t7.Y.RH3.tknl/hvQeMO7To8GbLauZ8CPMK32mvqiyXbGzG/2',NULL,1,1);
...
-- Dump completed on 2026-09-24 13:16:07
